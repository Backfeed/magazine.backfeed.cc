...
//    return $button_input;
    return '<button type="submit" id="gform_submit_button_1" class="gform_button button token-fee-button" tabindex="9" onclick="if(window[\'gf_submitting_1\']){return false;}  if( !jQuery(\'#gform_1\')[0].checkValidity || jQuery(\'#gform_1\')[0].checkValidity()){window[\'gf_submitting_1\']=true;}" onkeypress="if(window[\'gf_submitting_1\']){return false;}  if( !jQuery(\'#gform_1\')[0].checkValidity || jQuery(\'#gform_1\')[0].checkValidity()){window[\'gf_submitting_1\']=true;}"><span>Submit</span><span></span><span>1 Token</span></button>';
}, 10, 2 );
