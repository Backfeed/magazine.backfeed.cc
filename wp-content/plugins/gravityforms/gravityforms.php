...
class GFForms {
	...
	public static function form_switcher() {
		...
		<a class="add-new-h2 form_switcher_button" href="" onclick="jQuery('#form_switcher').show().focus();jQuery(this).remove();return false;"><?php esc_html_e( 'Switch Form', 'gravityforms' ) ?></a>
