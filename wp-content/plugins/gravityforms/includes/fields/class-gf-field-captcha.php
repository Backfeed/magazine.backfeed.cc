		...
		switch ( $this->captchaType ) {
			...
			default:
				...
				if ( $is_entry_detail || $is_form_editor ){
					...
					wp_enqueue_script( 'gform_recaptcha', 'https://www.google.com/recaptcha/api.js?hl=' . $language . '&render=explicit&onload=renderRecaptcha', array(), false, true );

					$output .= "<div id='" . esc_attr( $field_id ) ."' class='ginput_container ginput_recaptcha' data-sitekey='" . esc_attr( $site_key ) . "' data-stoken='" . esc_attr( $secure_token ) . "' data-theme='" . esc_attr( $theme ) . "' ></div>";
