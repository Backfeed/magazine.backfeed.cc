...
class GF_Field_List extends GF_Field {
	...
	public function get_field_input( $form, $value = '', $entry = null ) {
		...
		if ( ! self::$_style_block_printed ){
			...
			$list .= '<style type="text/css">  body .gform_wrapper table.gfield_list tbody tr td.gfield_list_icons img.add_list_item,
						body .gform_wrapper table.gfield_list tbody tr td.gfield_list_icons img.delete_list_item {
						...
						body .gform_wrapper .gform_body .gform_fields .gfield .ginput_container_list tbody tr td.gfield_list_icons img.add_list_item {
						...
						body .gform_wrapper table.gfield_list tbody tr td.gfield_list_icons img.add_list_item:hover,
						body .gform_wrapper table.gfield_list tbody tr td.gfield_list_icons img.delete_list_item:hover {
							opacity: 1.0;
						}</style>';
